...
<body>
	<div id="Header">
		<img src="/twitter/resources/image/5.png"/>
		<p>
			...
			<a href="/twitter/service/followerList"><input type="button" value="Follwer" /></a> 
	...
	<div id="allUserListContent">
		<c:forEach items="${allUserList}" var="follow">
				...
				<tr>
					...
					<c:choose>
						<c:when test="${follow.state }">
							<a href="/twitter/service/unfollow?userNum=${follow.user.userNum}&url=/service/allUserList">
								<input type="button" value="UnFollow" />
							</a>
						</c:when>
						<c:otherwise>
							<a href="/twitter/service/follow?userNum=${follow.user.userNum}&url=/service/allUserList">
